...
def run(
        ...
        classes=[0, 2, 7],  # filter by class: --class 0, or --class 0 2 3
...
def parse_opt():
    ...
    parser.add_argument('--classes', nargs='+', type=int, default=[0, 2, 7], help='filter by class: --classes 0, or --classes 0 2 3')
